...
st.markdown("""
<style>
.big-title { font-size: 2rem; font-weight: 800; color: #6366f1; }
.tag { background: #312e81; color: #a5b4fc; padding: 2px 8px; border-radius: 12px; font-size: 0.72rem; margin: 2px; display: inline-block; }
.recruiter-box { background: linear-gradient(135deg, #1e1b4b, #312e81); border-radius: 12px; padding: 20px; color: white; margin-bottom: 20px; border-left: 4px solid #6366f1; }
.metric-num { font-size: 1.4rem; font-weight: 800; color: #a5b4fc; }
</style>
...
Thank you for taking the time to review.</p>

<p>And this is exactly what I bring to the table —<br>
I know how to engineer things the way they can benefit the best.</p>
...
🌐 <span class="metric-num">4</span> sources scraped via REST APIs<br>
...
<p>And my instincts say we're already a great match —<br>
if you're looking for someone who doesn't just work with data,<br>
but engineers it, analyzes it, finds meaning in it<br>
and drives real business decisions with it.</p>
